...
Painting.create(:title => 'A Woman', :year => '1656', :style => 'canvas', :image => 'http://www.arttherapyblog.com/uimages/2010/10/picasso_woman_b.jpg', :artist => art2, :museum => mus2)
Painting.create(:title => 'Butterfly Ship', :year => '1837', :style => 'water colors', :image => 'http://www.idealnetworker.com/home/idealnet/public.html/wp-content/uploads/2011/04/art-salvador-dali.jpg', :artist => art3, :museum => mus1)
...
Painting.create(:title => 'Lydia', :year => '1734', :style => 'oil', :image => 'http://www.arthermitage.org/Henri-Matisse/Portrait-of-Lydia-Delectorskaya.jpg', :artist => art5, :museum => mus1)
